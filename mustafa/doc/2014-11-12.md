...
No explicit keyword is needed to to override a virtual function in C++03. In C++11, keyword `override` has been
...
<font color='red'> This section will be completed later.</font>  
Rvalue reference are powerful to enable two things: 1) move semantics and 2) perfect forwarding.  

Recommended [article](http://isocpp.org/blog/2012/11/universal-references-in-c11-scott-meyers) for our forthcoming 
discussion.
